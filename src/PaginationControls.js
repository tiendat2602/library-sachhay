...
export class PaginationControls extends Component {
    ...
    constructor(props) {
        ...
        this.sortKeys = this.props.keys || ["Title", "Author"];
    }
    ...
    render() {
        return <div className="bg-light pb-2">
                ...
                <div className="form-inline justify-content-center">
                    <select className="form-control"
                        ...
                        { this.pageSizes.map(s => 
                            <option value={s} key={s}>{s}/trang</option>
                        )}
                    </select>
                    <select className="form-control"
                        ...
                        { this.sortKeys.map(k => 
                            <option value={  k === "cateName" ? k : k.toLowerCase()} key={k}>
                                Xếp theo { k === "cateName" ? "Category" : k }
                            </option>
                        )}
                    </select>
            </div>
